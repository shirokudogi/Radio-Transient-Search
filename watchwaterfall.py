...
def main(args):
   ...
   plt.imshow(waterfall.T, cmap='afmhot', origin = 'low', aspect = 'auto')
   ...
   yTicksPos = np.linspace(0.0, 1.0, numYTicks)
   yTicksLabels = np.linspace(lowerIndex, upperIndex, numYTicks)
